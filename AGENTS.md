...
11. **Public API v1 (MVP)** — user tạo API key tại `/billing`, gọi `POST /api/v1/images/generate` bằng Bearer để tạo 1 ảnh (n8n/automation). Docs: `docs/public-api-v1.md`.
