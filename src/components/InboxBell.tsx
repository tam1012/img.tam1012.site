            ...
            {active ? (
              ...
              <div>
                ...
                <div className="max-h-[70vh] overflow-y-auto px-3 py-3">
                  ...
                  <div className="mt-1 mb-2 flex items-center gap-2 text-[10px] text-zinc-500">
                  ...
                  <p className="whitespace-pre-wrap text-sm leading-relaxed text-zinc-200">{active.body}</p>
                </div>
              </div>
            ) : (
              // ---- Danh sách tin ----
